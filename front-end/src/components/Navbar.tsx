import {Bell, User, LogOut, Heart, Crown, ShoppingBag} from "lucide-react";
                    ...
                    <div className="ml-2 dropdown dropdown-end">
                        ...
                        <div tabIndex={0} role="button" className="cursor-pointer">
                            <div className="avatar hover:opacity-80 transition-opacity">
                                <div
                                    className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border-2 border-primary-300 shadow-sm">
                                    <img
                                        src={
                                            user.profilePicture ||
    ...
    font-medium rounded-lg px-3 py-2"
                    ...
                    <>
                        ...
                        <div className="hidden sm:flex items-center gap-2 ml-2">
                            <Link to={"/login"}>
                                <button
                                    className="btn btn-ghost text-neutral-700 hover:text-primary hover:bg-primary-50 font-medium rounded-xl">
                                    Đăng nhập
                                </button>
                            </Link>
                            ...
                            <Link to={"/register"}>
                                <button
                                    className="btn bg-primary-500 text-white border-none hover:bg-primary-600 shadow-sm font-medium rounded-xl">
                                    Đăng ký
                                </button>
                            </Link>
                        </div>
